...
<script type="text/javascript">
	...
	function login(){
		...
		f.action = "<%=cp %>/join.do?method=login_ok";
		f.submit();
	}
	...
	function amendInfor(){
		...
		f.action = "<%=cp %>/join.do?method=created&mode=updateok";
		f.submit();
	}
</script>
</head>
...
<tr height="30">
	...
	<input type="button" value="정보수정" class="btn2" 
	onclick="amendInfor();">
	</td>
</tr>
<tr height="30">
...
<c:choose>
	...
	<a href="javascript:location.href='<%=cp %>/join.do?method=searchpw';">비밀번호 찾기</a>
	</td></tr>
	<tr height="1"><td colspan="2" bgcolor="#cccccc"></tr>
	</c:when>
</c:choose>
